...
class Pagination 
{
    ...
    /**
     * 
     * @var Ключ для GET, в котором пишется номер страницы
     * 
     */
    private $index = 'page';
    ...
    /**
     * Запуск необходимых страниц для навигации
    ...
    public function __construct($total, $currentPage, $limit, $index) 
    {
        ...
        # Устанавливаем номер текущей сраницы
    ...
    public function get() 
    {
        ...
        # Генерируем ссылки
        for ($page = $limit[0]; $page <= $limit[1]; $page++) {
            # Если текущая это текущая страница, ссылки нет добавляется ключ active
    ...
    private function generateHtml($page, $text = null) 
    {
        ...
        # Формируем HTML код ссылку и возвращаем
        return
    ...
    private function setCurrentPage($currentPage) 
    {
        ...
        if ($this->current_page > 0) {
            ...
            if ($this->current_page > $this->amount)
            # Устанавливаем старнцицу на последнюю
